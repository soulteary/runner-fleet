...
Open http://localhost:8080. The default image tag is the stable release (e.g. v1.2.0). For more options (docker run, DinD, container mode, using `main` or other tags) see the [User Guide](docs/guide.md). Health: `GET /health`; version: `GET /version`.
