...
本番では特定バージョン（例: v1.3.0）を使用してください。開発時は `main` タグが使えます。
...
| `runners.container_image` | コンテナモード時の Runner イメージ（-runner タグ） | `ghcr.io/soulteary/runner-fleet:v1.3.0-runner` |
