...
生产环境建议使用具体版本号（如 v1.3.0）；开发可用 `main` tag。
...
| `runners.container_image` | 容器模式下 Runner 镜像（tag 带 -runner） | `ghcr.io/soulteary/runner-fleet:v1.3.0-runner` |
