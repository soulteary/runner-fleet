...
Produktion: konkrete Version verwenden (z. B. v1.3.0). Für Entwicklung kann der Tag `main` genutzt werden.
...
| `runners.container_image` | Runner-Image im Containermodus (Tag -runner) | `ghcr.io/soulteary/runner-fleet:v1.3.0-runner` |
